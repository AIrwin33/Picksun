...
console.log({ env });
const socketUrl =
  env === "development" ? "http://localhost:5432" : "https://play.pick.fun";
      ...
      <div id="contestContainer">
        ...
        <Row className="rowBar">
          ...
          <Col xs={10} sm={6} className="text-center ">
            <h4 className="whiteText fontBold aptifer">
              {contest.sub_title__c}
            </h4>
          </Col>
          <Col xs={1} sm={3}></Col>
        </Row>
        ...
        >
          <Tab
            eventKey="Questions"
            title="Questions"
            className="aptifer pb-4 pt-4 tabwidth"
          >
            <Row>
              <Col lg={3} sm={1}></Col>
              <Col lg={6} sm={10}>
                {isloaded && (
                  <Questions
                    tabset={tabset}
                    updatepart={updateparts}
                    sport={sport}
                    contestid={contest.sfid}
                    contestQuestionText={contest.no_questions_text__c}
                    contest={contest}
                    participation_id={participation.externalid__c}
                    partsfid={participation.sfid}
                    newQuestion={newQuestion}
                    newCorrectQuestion={newCorrectQuestion}
                  />
                )}
              </Col>
              <Col lg={3} sm={1}></Col>
          ...
          <Tab
            ...
            title="Participants"
            className="pb-4 pt-4 aptifer tabwidth"
          >
            ...
            <Row className="partCard">
              ...
              <Col lg={6} sm={10}>
                <Row className="colCard ">
                  <Col xs={1} lg={1} className="nopadding"></Col>
                  <Col xs={9} lg={10} className="nopadding">
                    <div className="text-center">
                      <span class="aptifer">
                        Participants Remaining: {activeParts}/{allParts}
                      </span>
                    </div>
                  </Col>
                    ...
                    <div className="infoDiv mb-4 justify-content-end">
                      ...
                      >
                        ...
                        <Modal.Body className="proxima font12 modalBody">
                          <span>- Pick an answer for each question.</span>{" "}
                          <br />
                          <span>
                            - Click ‘Submit Answers’ before countdown timer
                            reaches zero
                          </span>
                          <br />
                          <span>
                            - Your picks are graded in real-time when the
                            correct answer becomes known in the live event
                          </span>
                          <br />
                          <span>
                            - If or when you reach the limit for wrong answers -
                            the Knockout Limit - you’re removed from the contest
                          </span>
                          <br />
                          <span>
                            - Click Participants to keep track of how your
                          ...
                          <br />
                          <span>
                            - Visit our website for details on scoring &amp;
                            prizes (https://www.pick.fun/rules)
                          </span>
                        </Modal.Body>
                        <Modal.Footer>
                          <Button
                ...
                {contest.status__c === "Finished" && (
                  <div>
                    {allPartsList.map((part) => {
                      return (
                        <Row key={part.id} className="colCard ">
                          ...
                          <Col xs={10}>
                            <Row>
                              <span className="fontBold proxima">
                                {part.participant_name__c}
                              </span>
                              {part.sfid === participation.sfid && (
                                <div className="yourpart ml-3 proxima">You</div>
                              )}
                            </Row>
                            <Row>
