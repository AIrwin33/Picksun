  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="btn-group m-3" role="group" aria-label="Basic example" >
          <button type="radio" value="A" className="btn btn-primary questionButton" disabled={quest.islocked__c} onClick={handleRadioChange}>{quest.answer_a__c}</button>
          <button type="radio" value="B" className="btn btn-primary questionButton" disabled={quest.islocked__c} onClick={handleRadioChange}>{quest.answer_b__c}</button>
          {quest.answer_c__c !== null &&
            <button type="radio" value="C" className="btn btn-primary questionButton" disabled={quest.islocked__c} onClick={handleRadioChange}>{quest.answer_c__c}</button>
          }
          {quest.answer_d__c !== null &&
            <button type="radio" value="D" className="btn btn-primary questionButton" disabled={quest.islocked__c} onClick={handleRadioChange}>{quest.answer_d__c}</button>
          }
{/* 
