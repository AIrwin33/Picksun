...
app.post("/submitpartanswers", async(req, res) => {
    try {
        ...
        const cs = new pgp.helpers.ColumnSet(['?participation__c', '?question__c','selection__c', 'selection_value__c','status__c', 'ExternalId__c'], {table: 'salesforce.participation_answers__c'});
        console.log(cs);
